        ...
        <header class="flex items-center h-24 py-4 z-20 {{ $page->isHomePage() ? null : 'bg-white border-b mb-2' }}" role="banner">
            <div class="container flex items-center max-w-8xl mx-auto px-4 lg:px-8">
                ...
                <div class="flex flex-1 justify-end items-center text-right md:pl-10">
                    ...
                    <a href="/docs/" class="ml-6 hidden md:inline {{ $page->isHomePage() ? 'text-white' : 'text-blue-800' }}" title="LdapRecord Documentation Link">Docs</a>

                    <a href="/docs/laravel" class="ml-6 hidden md:inline {{ $page->isHomePage() ? 'text-white' : 'text-blue-800' }}" title="LdapRecord-Laravel Documentation Link">Laravel</a>
