            ...
            <div class="container flex items-center max-w-8xl mx-auto px-4 lg:px-8">
                ...
                <div class="flex flex-1 justify-end items-center text-right md:pl-10">
                    ...
                    @if($page->isOnParent('/docs/laravel'))
                        <a href="/docs/" class="ml-6 hidden md:inline whitespace-no-wrap {{ $page->isHomePage() ? 'text-white' : 'text-blue-800' }}" title="LdapRecord Documentation Link">
                            {{ $page->isOnParent('/docs/laravel') ? 'Core Docs' : 'Docs' }}
                        </a>

                        <a href="https://github.com/DirectoryTree/LdapRecord-Laravel" class="hidden sm:inline {{ $page->isActive('/') ? 'text-white' : 'text-blue-800' }}">
