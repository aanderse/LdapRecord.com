...
> view [this guide](/docs/laravel/auth/importing) instead.
...
As with [importing LDAP users](/docs/laravel/auth/importing), you may also use an [attribute handler](/docs/laravel/auth/configuration/#attribute-handlers)
